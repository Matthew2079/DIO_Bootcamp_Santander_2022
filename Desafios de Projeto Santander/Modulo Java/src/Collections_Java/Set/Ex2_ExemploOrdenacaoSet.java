...
public class Ex2_ExemploOrdenacaoSet {
    ...
    public static void main(String[] args) {
       ...
       minhasSeries3.addAll(minhasSeries); // Adicionando as series
...
//     Pra você
       ...
       minhasSeries4.addAll(minhasSeries); // Adicionando as series
       for ( Serie serie: minhasSeries4 )
            System.out.println(serie.getNome() + " - " + serie.getGenero() + " - " + serie.getTempoEpisodio());

       System.out.println("--\tOrdem Tempo Episódio\t--");
       Set<Serie> minhasSeries5 = new TreeSet<>(new ComparatorTempoEpisodio());
       minhasSeries5.addAll(minhasSeries); // Adicionando as series
